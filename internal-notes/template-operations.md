...
git tag -a draft-dsmullen-ppd-architecture-00 -m "Submit draft-dsmullen-ppd-architecture-00"
git push origin draft-dsmullen-ppd-architecture-00
```
...
```sh
git tag -d draft-dsmullen-ppd-architecture-00
git push origin :draft-dsmullen-ppd-architecture-00
```
